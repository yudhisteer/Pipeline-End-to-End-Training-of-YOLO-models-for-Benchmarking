...
class SageMakerDataManager:
    ...
    def check_data_in_s3(self) -> Tuple[bool, bool, Dict[str, str]]:
        ...
        expected_dataset_s3 = (
            ...
            or f"s3://{self.bucket}/{self.prefix}/yolo-dataset/"
        )
    ...
    def upload_data_to_s3(self, force_upload: bool = False) -> Tuple[str, str]:
        ...
        dataset_dir = data_config.get('dataset_dir') or os.path.join('dataset', 'yolo-dataset')
        ...
        dataset_channel = f"{self.prefix}/yolo-dataset"
